...
void cal1Elem(int nRefDom, int nbRefD0, int *numRefD0, int nbRefD1, int *numRefD1, 
        int nbRefF1, int *numRefF1, int typeEl, int nbneel, float **coordEl, 
        int nbaret, int nRefArEl[], float **MatElem, float *SMbrElem, int *NuDElem, float *uDElem){
...
// Calcul de la matrice et du seconde membre élémentaire de l'élément
...
// Recherche des aretes avec une condition de Dirichlet
    // for(i = 0 ; i < nbaret ; i++){
    //     aretTrouve = 0;
...
// Calcul de la matrice et du seconde membre élémentaire sur les aretes de l'élément 
    // int nbneAr = 2;
